...
A. 86.3961% of structures are Protein (only). However there are more strucutres with Protein/Oligosaccharide and Protein/NA and this accounts for 97.89729%.
...
A. In this strucutre we only see the Oxygen atom from the water, which is what makes the binding. 
...
A. 198 amino acid residues.
>Q8: Name one of the two non-protein residues? 
A. HOH
>Q9: How many protein chains are in this structure? 
A. There are 2 chains.
...
A. The package msa is found only on BioConductor and not on CRAN

>Q11. Which of the above packages is not found on BioConductor or CRAN?: 
A. The package bio3d-view is not found on BioConductor or CRAN; it is available through BitBucket.
...
A. The black and colored lines are different, they contain different peaks. They are two different structural conformations of Adk and differ by a collective low frequency displacement of two nucleotide-binding site regions that display distinct flexibilities upon nucleotide binding. 
